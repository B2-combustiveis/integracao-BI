...
class ClienteGruposController extends Controller
{
    private const ENDPOINT = '/INTEGRACAO/GRUPO_CLIENTE';

    public function __invoke(Request $request, WebPostoClient $webPosto, ClienteGrupoImporter $importer): JsonResponse
    {
