...
class ProdutoSubgruposController extends Controller
{
    private const ENDPOINT = '/INTEGRACAO/CONSULTAR_SUB_GRUPO_REDE';

    public function __invoke(
        Request $request,
        WebPostoClient $webPosto,
        ProdutoSubgrupoImporter $importer,
    ): JsonResponse {
        ...
        return response()->json([
            ...
            'records_count' => is_array($payload) && array_is_list($payload) ? count($payload) : null,
            'storage' => $storage,
            'data' => $payload,
