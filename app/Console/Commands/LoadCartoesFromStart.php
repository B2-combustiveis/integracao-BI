...
use App\Services\WebPosto\{CartaoImporter,WebPostoCursorSynchronizer};
use Illuminate\Console\Command;
use Illuminate\Support\Facades\DB;
class LoadCartoesFromStart extends Command {
 protected $signature='webposto:load-cartoes {empresa=4604} {--resume} {--pages=40}';
 protected $description='Padrão 2000: zera e recarrega cartões desde o cursor 1';
 public function handle(WebPostoCursorSynchronizer $sync,CartaoImporter $importer): int {
