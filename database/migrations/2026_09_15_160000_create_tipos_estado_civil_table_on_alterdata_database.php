...
return new class extends Migration
{
    ...
    {
        Schema::connection($this->connection)->create('tipos_estado_civil', function (Blueprint $table): void {
            $table->id();
    ...
    {
        Schema::connection($this->connection)->dropIfExists('tipos_estado_civil');
    }
};
