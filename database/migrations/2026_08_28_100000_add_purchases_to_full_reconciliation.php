...
return new class extends Migration
{
    public function up(): void
    {
        $this->updateResources(function (array $resources): array {
            $resources = array_values(array_diff($resources, ['compras']));
            $position = array_search('fornecedores', $resources, true);
            array_splice($resources, $position === false ? count($resources) : $position + 1, 0, ['compras']);
    ...
    public function down(): void
    {
        $this->updateResources(
            fn (array $resources): array => array_values(array_diff($resources, ['compras'])),
        );
    }
