...
return new class extends Migration
{
    public function up(): void
    {
        $this->updateResources(function (array $resources): array {
            $resources = array_values(array_diff($resources, ['titulos_pagar']));
            $position = array_search('compras', $resources, true);
            array_splice($resources, $position === false ? count($resources) : $position + 1, 0, ['titulos_pagar']);
    ...
    public function down(): void
    {
        $this->updateResources(
            fn (array $resources): array => array_values(array_diff($resources, ['titulos_pagar'])),
        );
    }
